		...
		<div class="container">
			...
			<div class="content">
				<div class="content-descr">
					<div class="content-descr__title">финансирование поставок</div>
					<div class="content-descr__text">Партнер LTS, Китайская корпорация страхования экспортных сделок, в очередной раз подтвердила высокий кредитный рейтинг нашей компании. Теперь мы готовы предложить своим постоянным клиентам кредит на покупку товаров из КНР по ставке от 1% в месяц!</div>
				</div>
				<div class="content-gallery">
					<div class="content-gallery__title">Галерея изображений</div>
					<div class="content-gallery__img">
						<img src="img/page/gallery-img11.jpg" alt="gallery-img11">
						<img src="img/page/gallery-img12.jpg" alt="gallery-img12">
					</div>
				</div>
				<div class="reviews">
