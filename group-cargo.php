		...
		<div class="container">
			...
			<div class="content">
				<div class="content-descr">
					<div class="content-descr__title">доставка сборных грузов</div>
					<div class="content-descr__text">Мы предлагаем своим клиентам выгодные условия по организации экспортных и импортных отправок грузов. Сроки доставки сборного отправления незначительно увеличиваются, однако перевозка данным способом позволяет добиться серьезной экономии затрат на логистику. Наша компания предлагает своим клиентам услугу по комплексному управлению цепочкой поставок с целью использования выгодных логистических решений на каждом этапе движения товара.</div>
				</div>
				<div class="content-gallery">
					<div class="content-gallery__title">Галерея изображений</div>
					<div class="content-gallery__img">
						<img src="img/page/gallery-img9.jpg" alt="gallery-img9">
						<img src="img/page/gallery-img10.jpg" alt="gallery-img10">
					</div>
				</div>
				<div class="reviews">
