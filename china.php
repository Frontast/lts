		...
		<div class="container">
			...
			<div class="content">
				<div class="content-descr">
					<div class="content-descr__title">доставка грузов из китая</div>
					<div class="content-descr__text">Стоимость услуг на грузоперевозку из Китая будет зависеть от того, каким способом вы решили доставить груз, а также от маршрута, вида транспорта и характера товара. В разделе "Калькулятор" мы публикуем реальную стоимость услуг доставки и таможенного оформления в пересчете за 1 кг груза.</div>
				</div>
				<div class="content-gallery">
					<div class="content-gallery__title">Галерея изображений</div>
					<div class="content-gallery__img">
						<img src="img/page/gallery-img3.jpg" alt="gallery-img3">
						<img src="img/page/gallery-img4.jpg" alt="gallery-img4">
					</div>
				</div>
				<div class="reviews">
