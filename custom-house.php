		...
		<div class="container">
			...
			<div class="content">
				<div class="content-descr">
					<div class="content-descr__title">таможенное оформление</div>
					<div class="content-descr__text">Таможенное оформление, или простыми словами «разтаможка» груза – это самый сложный этап доставки товара из другой страны, особенно если вы впервые сталкиваетесь с этой процедурой. Любое нарушение строгого таможенного порядка грозит серьезными штрафами, вплоть до конфискации товара. В этом вопросе не помогут сотни статей и даже самостоятельное заучивание Таможенного кодекса «от корки до корки», только многолетний опыт и не одна сотня оформленных деклараций.</div>
				</div>
				<div class="content-gallery">
					<div class="content-gallery__title">Галерея изображений</div>
					<div class="content-gallery__img">
						<img src="img/page/gallery-img5.jpg" alt="gallery-img5">
						<img src="img/page/gallery-img6.jpg" alt="gallery-img6">
					</div>
				</div>
				<div class="reviews">
